...
const API_KEY ="5c62b31254b2448c93df1e4fed7b82e1";
...
const getUserCoordinates=()=>{
    navigator.geolocation.getCurrentPosition(
        ...
        error =>{
          if(error){
            alert("Permission denied, Allow the location to get Weather Details");
          }
        }
    );
...
cityInput.addEventListener("keyup",data=> data.key ==="Enter" && getCityCoordinates());